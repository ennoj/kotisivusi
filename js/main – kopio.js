...
function addLink(e) {
  ...
  // Luo text node ja append to li
  li.appendChild(document.createTextNode(linkName.value));
  li.appendChild(document.createTextNode(linkUrl.value));
  ...
  // Icon
  deleteLink.innerHTML = '<i class="material-icons" style="color: white">remove_circle</i>';
